...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define :develop do |develop|
    ...
    develop.vm.network :private_network, ip: "192.168.60.10"
  ...
  config.vm.define :ci do |ci|
    ci.omnibus.chef_version = "12.18.31"
    ci.vm.hostname = "ci"
    ...
    ci.vm.network :private_network, ip: "192.168.60.100"
  ...
  config.vm.define :deploy do |deploy|
    deploy.omnibus.chef_version = "12.18.31"
    ...
    deploy.vm.network :private_network, ip: "192.168.60.200"
